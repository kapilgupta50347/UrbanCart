      ...
      {isCartOpen && (
        ...
        >
          <motion.div
            ...
            className="absolute right-0 top-0 h-full w-full max-w-md bg-[#001F3F] glass-card-dark shadow-2xl flex flex-col"
              ...
              {cartItems.length === 0 ? (
                ...
                cartItems.map(item => (
                  <div key={item.variant.id} className="flex items-center gap-4 bg-white/5 p-3 rounded-lg">
                    <img src={item.product.image} alt={item.product.title} class="w-20 h-20 object-cover rounded-md" />
